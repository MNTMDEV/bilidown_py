...
class BilidownObj(QObject):
    ...
    def videoRemux(self):
        avcom = AVCombine()
        avcom.setAudio(BilidownObj.getAbsolutePath(
            self.downDirectory, self.filenameAudio))
        avcom.setVideo(BilidownObj.getAbsolutePath(
            self.downDirectory, self.filenameVideo))
        avcom.setOutPath(BilidownObj.getAbsolutePath(
    ...
    def deleteTempM4s(self):
        self.removeFile(BilidownObj.getAbsolutePath(
            self.downDirectory, self.filenameAudio))
        self.removeFile(BilidownObj.getAbsolutePath(
            self.downDirectory, self.filenameVideo))
    ...
    def onDownloadClick(self, url, directory):
        ...
        self.fAudio = open(BilidownObj.getAbsolutePath(
            self.downDirectory, self.filenameAudio), "wb")
        self.fVideo = open(BilidownObj.getAbsolutePath(
